...
results_df.to_csv(
    "results/model_results_all_horizons.csv",
    index=False
)
...
accuracy_table = results_df.pivot_table(
    index=["Target", "Experiment"],
    columns="Model",
    values="Accuracy"
)

accuracy_table.to_csv(
    "results/accuracy_comparison_table.csv"
)

f1_table = results_df.pivot_table(
    index=["Target", "Experiment"],
    columns="Model",
    values="F1"
)
...
f1_table.to_csv(
    "results/f1_comparison_table.csv"
)

balanced_table = results_df.pivot_table(
    index=["Target", "Experiment"],
    columns="Model",
    values="Balanced Accuracy"
)

balanced_table.to_csv(
    "results/balanced_accuracy_table.csv"
)

print("\nSaved Results:")
print("results/model_results_all_horizons.csv")
print("results/accuracy_comparison_table.csv")
print("results/f1_comparison_table.csv")
print("results/balanced_accuracy_table.csv")
